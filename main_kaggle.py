...
train_dataset = ImageNet1k(label_files=args.get("train_dir"), transform=train_transform)
val_dataset = ImageNet1k(label_files=args.get("val_dir"), transform=test_transform)
